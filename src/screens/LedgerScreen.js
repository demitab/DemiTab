...
export const LedgerScreen = ({ eventData, isDarkMode, onExit }) => {
  ...
  // Ensures ledger syncs instantly if someone undoes a payment on the previous screen
  const { memberShares } = eventData.ledgerData;
  const paymentStrategy = eventData.paymentStrategy;
  ...
  }, [eventData, settlements, mainPayerId, paymentStrategy]);
